...
const createPaymentIntoDB = async (payload, tenantId) => {
...
const confirmPaymentIntoDB = async (payload, signature) => {
    try {
...
const getPaymentHistoryDB = async (userId) => {
...
const getPaymentDetailsDB = async (paymentId, userId) => {
